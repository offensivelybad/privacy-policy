...
Application means the software program provided by the Company downloaded by You on any electronic device, named NShape Sets

Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NShape Sets.
